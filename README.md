...
## Instructions
This repository exclusively contains the Android client-side implementation, which is designed to work in conjunction with a server that implements the same API.
If you wish to access the repository that includes both the updated server and the original web client, please click the following link: https://github.com/Brettler/leaflet_server_task3_Android.git
